...
const ProductPage = ({ location }) => (
  <Layout
    title="CallAsst is an call center automation voice bot company"
      ...
      <div className="container">
        <div className="row">
          <div className="col-sm-5 col-sm-offset-2">
            ...
            />
            <h1>CallAsst is AI powered call centers</h1>
            <p className="highlight-p">
              We're here to change the way calls are handled today and make the process automated
            </p>
